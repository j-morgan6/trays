defmodule Trays.BankAccounts do
  @moduledoc """
  ...
  @doc """
  Returns the list of bank_accounts for a given merchant_location.

  ## Examples

      iex> list_bank_accounts(merchant_location_id)
      [%BankAccount{}, ...]

  """
  def list_bank_accounts(merchant_location_id) do
    Repo.all_by(BankAccount, merchant_location_id: merchant_location_id)
  end
