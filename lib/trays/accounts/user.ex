defmodule Trays.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Trays.Repo)
  ...
  """
  def valid_password?(%Trays.Accounts.User{hashed_password: hashed_password}, password)
